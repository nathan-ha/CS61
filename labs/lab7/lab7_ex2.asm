...
;========================
; LAB QUESTIONS
; 1. I still get an infinite recursion.
; 2. R0 == x0DC4, R1 == 4
; 3. R0 didn't change but R1 == 3
; 4. R7 == x3207
; 5. The program keeps going
; 6. We backed up R7 weirdly in the beginning, and now it keeps jumping to the wrong address because the backup keeps getting overwritten.
;========================
